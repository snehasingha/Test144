...
function game(){///////////   C141
  ...
  console.log("noseX = " + noseX +" ,noseY =  "+ noseY);   ///////////   C141
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Press Play Button To Start The Game ", gameConfig.screenX/2, gameConfig.screenY/2);   ///////////   C142
    textSize(40);
...
function changeGameStatud(character){                                       ///////////   C142
 if(noseX !="" && gameConfig.status==="start" && GameStatus=="start") {     ///////////   C142
   document.getElementById("status").innerHTML = "Game Is Loaded";          ///////////   C142
   world_start.play();                                                      ///////////   C142
...
function instializeInSetup(character){
  ...
  bricks.displace(bricks);
	...
	coins.displace(coins);          ///////////   C143
	coins.displace(platforms);      ///////////   C143
	coins.collide(pipes);           ///////////   C143
	coins.displace(bricks);		      ///////////   C143
...
function checkStatus(character){    
  ...
  if(character.live==false && character.liveNumber==0){
    gameConfig.status="gameover";                         ///////////   C143
    mario_gameover.play();
  }
